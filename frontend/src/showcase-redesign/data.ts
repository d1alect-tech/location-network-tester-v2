...
const EDGE_STORAGE_PATH =
  "C:\\Users\\Kirill\\lnt-sessions\\архив-измерений\\2026\\август\\неделя-4\\локация-подъезд-этаж-3\\" +
  "щиток-2\\розетка-кухня\\замеры-после-ремонта-проводки\\повторная-серия-для-сравнения-с-базовой-записью\\" +
